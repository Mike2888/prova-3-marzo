...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230303_galantuomo_10b38d81da8a9b725861_20230303152459_archive.zip';
        const ARCHIVE_SIZE       = '327679';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '10b38d8-03152459';
        const SECONDARY_PACKAGE_HASH = 'ee4e80a-03152459';
